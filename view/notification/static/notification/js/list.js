...
const showList = (notification_info) => {
    ...
    notifications.forEach((notification) =>{
        ...
        let upload = '/upload/';
        const imageURL = notification.notification_file ? notification.notification_file : 'notification/2024/03/11/realfavicon.png';
