...
class CartTests(TestCase):
    # 로그인
    # data = {
    #     'member_email': 'zzanggu@gmail.com',
    ...
    # 장바구니 목록
    # cart_details = CartDetail.objects.all()
    # for cart_detail in cart_details:
    #     print(cart_detail.__dict__)


    # 상품 정보, 수량
    # print(CartDetail.objects.values('product__product_name', 'product__sell_price', 'quantity'))
